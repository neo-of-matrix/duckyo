...
describe('Validate TS configs', () => {
  ...
  it('Validate eslint-config-duckyo/typescript/vue', async () => {
  ...
  it('Validate eslint-config-duckyo/essential/typescript/vue', async () => {
  ...
  it('Validate eslint-config-duckyo/typescript/node', async () => {
