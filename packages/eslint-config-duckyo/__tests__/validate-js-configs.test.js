...
describe('Validate JS configs', () => {
  ...
  it('Validate eslint-config-duckyo/es5', async () => {
  ...
  it('Validate eslint-config-duckyo/vue', async () => {
  ...
  it('Validate eslint-config-duckyo/essential/es5', async () => {
  ...
  it('Validate eslint-config-duckyo/essential/vue', async () => {
  ...
  it('Validate eslint-config-duckyo/node', async () => {
